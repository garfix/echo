...
class Binder
{
	 ...
	 */
	public static function bindRelationProperties(Predication $Relation, array &$bindings)
	{
	...
	public static function bindRelationsProperties(PredicationList $Relations, array &$bindings)
	{
		$NewList = new PredicationList();

		foreach ($Relations->getPredications() as $Relation) {
			$NewList->addPredication(self::bindRelationProperties($Relation, $bindings));
		}
