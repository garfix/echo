...
class ParseTest extends Test
{
	function execute()
	{
		...
		$this->test(102, $sentences[0]->getSyntaxString(), '[S [VP [verb book][NP [determiner that][NBar [noun flight]]]]]');
		...
		$this->test(107, $sentences[1]->getSyntaxString(), '[S [VP [verb boek][NP [determiner die][NBar [noun vlucht]]]]]');
		...
		$this->test(203, $Sentence->getSyntaxString(), '[S [aux was][NP [propernoun Lord Byron]][VP [verb influenced]][passivisationPreposition by][NP [determiner the][NBar [NBar [noun author]][PP [preposition of][NP [propernoun Paradise Lost]]]]]]');
		...
		$this->test(251, $Sentence->getSyntaxString(), '[S [NP [propernoun John]][VP [verb sees][NP [determiner the][NBar [noun book]]]]]');
